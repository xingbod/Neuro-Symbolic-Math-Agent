% =========================================================================
% SUPPLEMENTARY MATERIAL S1: Reproducibility Manifest, Artifact Map,
...
\hypersetup{
    ...
    citecolor=blue,
    urlcolor=blue,
    pdftitle={Supplementary Material S1: Reproducibility Manifest and Artifact Map}
}

\setlength{\parindent}{0pt}
\setlength{\parskip}{6pt plus 2pt minus 1pt}

\title{\textbf{Supplementary Material S1: Reproducibility Manifest, Data Models, and Verifier Issue Taxonomy}}
...
% -------------------------------------------------------------------------
% SECTION S1.1: EXPERIMENT IDENTIFIERS AND SAMPLING SEEDS
% -------------------------------------------------------------------------
\section{S1.1 Experiment Identifiers and Sampling Seeds}\label{sec:s11-experiment-identifiers}
...
% -------------------------------------------------------------------------
% SECTION S1.2: DATASET PROVENANCE AND SHA-256 MANIFEST
% -------------------------------------------------------------------------
\section{S1.2 Dataset Provenance and SHA-256 Manifest}\label{sec:s12-dataset-provenance}

Table~\ref{tab:s1-dataset-provenance} details the upstream source endpoints, local file paths, and cryptographic SHA-256 hashes for all evaluation datasets.

\begin{table}[htbp]
\centering
\small
\caption{Dataset provenance, local storage paths, and cryptographic SHA-256 manifests.}
\label{tab:s1-dataset-provenance}
\begin{tabular}{lllll}
\toprule
...
% -------------------------------------------------------------------------
% SECTION S1.3: LLM PROVIDER AND RUNTIME SERVICE CONFIGURATION
% -------------------------------------------------------------------------
\section{S1.3 LLM Provider and Service Configurations}\label{sec:s13-service-configuration}

Table~\ref{tab:s1-model-service-configuration} summarizes the LLM service endpoints, sampling parameters, and context limits used during formalization and candidate generation.

\begin{table}[htbp]
\centering
\small
\caption{LLM service endpoints and hyperparameter configurations.}
\label{tab:s1-model-service-configuration}
\begin{tabular}{lllrr}
\toprule
...
% -------------------------------------------------------------------------
% SECTION S1.4: SERIALIZED DATA MODELS AND CONTROLLER STATES
% -------------------------------------------------------------------------
\section{S1.4 Serialized Data Models and Controller States}\label{sec:s14-data-models}
...
% -------------------------------------------------------------------------
% SECTION S1.5: VERIFIER FAILURE ISSUE TAXONOMY AND REFLECTION PROMPTS
% -------------------------------------------------------------------------
\section{S1.5 Verifier Failure Issue Taxonomy and Reflection Mappings}\label{sec:s15-issue-taxonomy}

When candidate verification fails, the \texttt{SymbolicVerifier} categorizes the failure into an issue taxonomy code. The \texttt{ReflectionEngine} maps these codes into prompt constraints for the next attempt (Table~\ref{tab:s1-issue-taxonomy}).

\begin{table}[htbp]
\centering
\small
\caption{Verifier issue taxonomy codes and corresponding reflection prompt actions.}
\label{tab:s1-issue-taxonomy}
\begin{tabular}{lll}
\toprule
...
% -------------------------------------------------------------------------
% SECTION S1.6: POST-HOC ANSWER-AUDIT IMPLEMENTATION
% -------------------------------------------------------------------------
\section{S1.6 Post-Hoc Answer-Audit Implementation}\label{sec:s16-answer-audit}
...
% -------------------------------------------------------------------------
% SECTION S1.7: ARTIFACT DIRECTORY MAP AND REGENERATION COMMANDS
% -------------------------------------------------------------------------
\section{S1.7 Artifact Directory Map and Regeneration Commands}\label{sec:s17-artifact-map}
...
\label{tab:s1-artifact-directory-map}
\begin{tabular}{ll}
\toprule
